...
VALUES
    ('Vladislave', 'Kheynov',    '2000-12-17', 1,  1,  '2010-06-06'),
    ('Galina',     'Sidorenko',  '2000-07-09', 2,  2,  '2010-05-12'),
    ('Timur',      'Igenov',     '2000-01-21', 3,  3,  '2010-09-17'),
    ('Ermak',      'Abdkdrve',   '2000-05-06', 4,  4,  '2010-09-16'),
    ('Andrew',     'Obidientov', '2000-05-02', 5,  5,  '2010-09-18'),
    ('Aboba',      'Bibinus',    '2000-12-27', 6,  6,  '2010-06-26'),
